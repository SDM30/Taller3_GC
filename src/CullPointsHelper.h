 ...
 * 
 * Implementa un algoritmo que elimina vértices basándose en un umbral de altura,
 * calculado a partir de la media y desviación estándar de los vecinos cercanos.
 */
